...
from results import Results, convert_sNMDA_to_current_exc_Jercog, convert_sNMDA_to_current_inh_Jercog
...
p['recordStateVariables'] = ['v', 'sE', 'sI', 'iAdapt', 's_NMDA_tot']
...
NMDA_E0 = convert_sNMDA_to_current_exc_Jercog(JN, 0) / pA
NMDA_E1 = convert_sNMDA_to_current_exc_Jercog(JN, 1) / pA
NMDA_I0 = convert_sNMDA_to_current_inh_Jercog(JN, 0) / pA
