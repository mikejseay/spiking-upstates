...
p['propConnect'] = 0.5
p['simName'] = 'jercogUpCrit_Buono1e3P05'
p['nUnits'] = 1e3
...
# JN.unitsExc.jE = JN.unitsExc.jE * 1.041
# JN.unitsExc.jI = JN.unitsExc.jI * 0.959
# JN.unitsInh.jE = JN.unitsInh.jE * 0.989
# JN.unitsInh.jI = JN.unitsInh.jI * 1.014
...
JN.prepare_upCrit_experiment2(minUnits=20, maxUnits=30, unitSpacing=2, timeSpacing=3000 * ms,
